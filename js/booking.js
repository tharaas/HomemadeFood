                ...
                <div v-if="!afterSubmit" class="app"> 
                    <from v-on:submit.prevent>
                        ...
                        <div class="input field col s6">
                            ...
                            <label for="people" class="customerinfo">How many people in the tuble</label>
                        </div>
                        ...
                        <hr>
                            <a @click="post" class="waves-effect waves-light btn-large yellow"><i class="material-icons left Medium">event</i>Make Reserve</a>
                    </from>
                </div>
            </div>`,
    data(){
